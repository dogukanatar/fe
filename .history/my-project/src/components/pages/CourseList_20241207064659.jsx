...
import { Search, X } from 'lucide-react'import React, { useEffect, useState } from 'react';
import { BrowserRouter as Router } from "react-router-dom";
import { Menu, MessageCircle, Calendar, BookOpen, List, LogIn, UserPlus } from "lucide-react";
import SignIn from "../pages/auth/SignIn"; // Changed from "./pages/auth/SignIn"
import SignUp from "../pages/auth/SignUp";export default function CourseList() {
  ...
  const filterCourses = (search, currentFilters) => {
    let filtered = mockCourses.filter(course => {
      ...
      const filterMatch = 
        ...
        (currentFilters.language === '' || (currentFilters.language === 'english' ? course.english_class : !course.english_class));
