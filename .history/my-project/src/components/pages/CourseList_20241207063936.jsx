  ...
  const mockCourses = [
    {
      ...
      weeklySchedule: [
        { week: 1, topic: "C Programming Overview", content: "Introduction. Writing, compiling, and debugging C programs. Hello world.Introduction. Writing, compiling, and debugging C programs. \n Hello world.Introduction. Writing, compiling, and debugging C programs. Hello world." },
